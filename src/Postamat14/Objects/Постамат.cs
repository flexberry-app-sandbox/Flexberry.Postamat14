...
namespace IIS.Postamat14
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat14.Статусы fСтатус;
        
        private IIS.Postamat14.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Postamat14.DetailArrayOfРегистрХран fРегистрХран;
        ...
        public virtual IIS.Postamat14.Статусы Статус
        {
            get
            {
                ...
                IIS.Postamat14.Статусы result = this.fСтатус;
        ...
        public virtual IIS.Postamat14.DetailArrayOfРегистрХран РегистрХран
        {
            get
            {
                ...
                {
                    this.fРегистрХран = new IIS.Postamat14.DetailArrayOfРегистрХран(this);
                }
                IIS.Postamat14.DetailArrayOfРегистрХран result = this.fРегистрХран;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Postamat14.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Postamat14.Постамат));
                }
            }
        }
    }

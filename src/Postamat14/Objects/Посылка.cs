...
namespace IIS.Postamat14
{
    ...
    public class Посылка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat14.Статус fСтатус;
        
        private IIS.Postamat14.Пользователь fПользователь;
        ...
        public virtual IIS.Postamat14.Статус Статус
        {
            get
            {
                ...
                IIS.Postamat14.Статус result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "Пользователь"})]
        [NotNull()]
        public virtual IIS.Postamat14.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.Postamat14.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПосылкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПосылкаE", typeof(IIS.Postamat14.Посылка));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПосылкаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПосылкаL", typeof(IIS.Postamat14.Посылка));
                }
            }
        }
    }

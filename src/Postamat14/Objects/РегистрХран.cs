...
namespace IIS.Postamat14
{
    ...
    public class РегистрХран : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat14.Постамат fПостамат;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat14.Постамат.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Постамат"})]
        public virtual IIS.Postamat14.Постамат Постамат
        {
            get
            {
                ...
                IIS.Postamat14.Постамат result = this.fПостамат;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрХранE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрХранE", typeof(IIS.Postamat14.РегистрХран));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРегистрХран : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat14.DetailArrayOfРегистрХран members)

        // *** End programmer edit section *** (IIS.Postamat14.DetailArrayOfРегистрХран members)
        ...
        /// </summary>
        public DetailArrayOfРегистрХран(IIS.Postamat14.Постамат fПостамат) : 
                base(typeof(РегистрХран), ((ICSSoft.STORMNET.DataObject)(fПостамат)))
        {
        }
        
        public IIS.Postamat14.РегистрХран this[int index]
        {
            get
            {
                return ((IIS.Postamat14.РегистрХран)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat14.РегистрХран dataobject)
        {
